...
public class GroceryStoreController {
    ...
    private ArrayList<Item> createOrder(@RequestBody Order order) {
        ...
        // determine if discounts apply, and automatically apply
        // any discounts that do apply. Will return a list of objects with all the necessary information for a receipt.
